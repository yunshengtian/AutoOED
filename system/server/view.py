...
class ServerLoginView:
    ...
    def __init__(self, root):
        ...
        self.widget = {}
        self.widget['user'] = create_widget('labeled_entry', master=frame_login, row=0, column=0, width=20,
            text='Username', class_type='string', required=True, required_mark=False)
        self.widget['passwd'] = create_widget('labeled_entry', master=frame_login, row=1, column=0, width=20,
            text='Password', class_type='string', required=False)
        self.widget['login'] = create_widget('button', master=frame_login, row=2, column=0, text='Log in')
