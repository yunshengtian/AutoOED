...
class PerformanceSpaceView:
    ...
    def __init__(self, root_view, n_obj):
        ...
        self.titles = ['obj_name', 'obj_lb', 'obj_ub', 'minimize']
        ...
        self.widget['performance_excel'] = Excel(master=frame_performance, rows=self.n_obj, columns=4, width=15,
            title=[config_map['problem'][title] for title in self.titles], dtype=[str, float, float, bool])
