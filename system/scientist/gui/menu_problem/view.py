...
class MenuProblemView:
    ...
    def __init__(self, root_view):
        ...
        self.widget['browse_p_eval'], self.widget['disp_p_eval'] = create_widget('labeled_button_entry',
            master=frame_config_display, row=5, column=0, label_text=config_map['problem']['performance_eval'], button_text='Browse', width=30)
        ...
        self.cfg_widget = {
            ...
            'performance_eval': self.widget['disp_p_eval'],
            'constraint_eval': self.widget['disp_c_eval'],
        }
    ...
    def enable_config_widgets(self):
        ...
        '''
        for key in ['save', 'cancel', 'set_design', 'set_performance', 'browse_p_eval', 'browse_c_eval']:
